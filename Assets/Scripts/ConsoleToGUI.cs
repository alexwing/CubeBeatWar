...
public class ConsoleToGUI : MonoBehaviour
{
    ...
    [Tooltip("Display log in UI")]
    public bool DisplayInUi = false;

    [Tooltip("Display log in TextMesh")]
    public bool DisplayInTextMesh = false;
    ...
    void OnTeshMesh()
    {
        if (DisplayInTextMesh)
        {
            GetComponent<TMPro.TextMeshPro>().text = myLog;
        }
    }
    void OnGUI()
    {
